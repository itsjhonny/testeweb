...
let Token = class Token {
    ...
    generateToken() {
        this.barcodeScanner.encode(this.barcodeScanner.Encode.TEXT_TYPE, 'gerando_token').then(data => {
        }, (err) => {
            console.log("erro ", err);
        });
    }
    scanToken() {
        return this.barcodeScanner.scan({ prompt: 'Coloque o QRCODE dentro da área' });
    }
};
Token.ctorParameters = () => [
    { type: _ionic_native_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_2__["BarcodeScanner"] }
];
Token = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _Providers_Token__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Providers/Token */ "./src/app/Providers/Token.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _Providers_Token__WEBPACK_IMPORTED_MODULE_9__["Token"],
            //QRScanner,
...
module.exports = __webpack_require__(/*! /home/jp/Desktop/ini_app/ini_v5_pwa/src/main.ts */"./src/main.ts");
